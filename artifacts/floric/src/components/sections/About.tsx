    ...
    <section id="ueber-uns" className="py-32 bg-card relative overflow-hidden border-y border-border">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            <span className="text-primary uppercase tracking-[0.2em] text-sm font-medium mb-4 block">{t.about.tag}</span>
            <h2 className="text-4xl md:text-5xl font-serif mb-8 text-foreground leading-tight">
              {t.about.title} <br /><span className="text-primary italic">{t.about.titleAccent}</span>
            </h2>
            ...
            <div className="mt-12">
              ...
              <div className="text-sm uppercase tracking-widest text-primary mt-2">{t.about.founderTitle}</div>
            </div>
          </div>
        </div>
      </div>
