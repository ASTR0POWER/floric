...
const de: Translations = {
  ...
  about: {
    ...
    p4: "Wir beraten Sie persönlich und herzlich – auf Deutsch und Russisch. So können wir sicherstellen, dass jeder Wunsch wirklich verstanden und perfekt umgesetzt wird.",
    founderTitle: "Gründerin & Geschäftsführerin",
  },
  gallery: {
    tag: "Portfolio",
    title: "Erinnerungen in Gold",
  },
  process: {
...
const ru: Translations = {
  ...
  hero: {
    ...
    langBadge: "Консультация на русском и немецком языке · Beratung auf Deutsch",
  ...
  about: {
    ...
    p4: "Мы консультируем вас лично и с душой — на русском и немецком языке. Так мы гарантируем, что каждое желание будет по-настоящему понято и идеально воплощено.",
    founderTitle: "Основатель и генеральный директор",
  },
  gallery: {
    tag: "Портфолио",
    title: "Воспоминания в золоте",
  },
  process: {
  ...
  contact: {
    ...
    langLine1: "Мы консультируем на русском и немецком языке",
    langLine2: "Beratung auf Deutsch verfügbar",
    addressTitle: "Адрес",
...
export const translations: Record<Language, Translations> = { de, ru };
